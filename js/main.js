(() => {
  ...
  var targets = document.querySelectorAll(".js-show-right");
  ...
  var observer2 = new IntersectionObserver(callback2);
  var targets2 = document.querySelectorAll(".js-show-left");
